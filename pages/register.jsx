      ...
      <div className="bg-register py-20">
        ...
        <div className="grid grid-cols-2">
            ...
            <label htmlFor="name" className='mr-2'>Nome</label>
              <input
                ...
                autoFocus
                onFocus={() => {
                  setTip("Primeiro nome do dono da conta, posteriormente pode ser utlizado para processar pagamentos.");
                }}
              />
            ...
            <div className="last-name">
              <label htmlFor="lastName" className='ml-2'>Sobrenome</label>
              ...
              <input
                ...
                autoFocus
                onFocus={() => {
                  setTip("Sobrenome (todos os nomes além do primeiro), também utilizado para processar pagamentos.");
                }}
              />
          ...
          <input
            ...
            autoFocus
            onFocus={() => {
              setTip("Email que será utilizado para comunicações, tenha certeza que existe e te pertence.");
            }}
          />
          {errors.email && (
        ...
        <div className="mb-4">
          ...
          <input
            ...
            autoFocus
            onFocus={() => {
              setTip(" Senha que será utilizada para realizar o login, deve conter pelo menos 6 caracteres, contendo: uma letra minúscula, uma letra maiúscula e um número.");
            }}
          />
          {errors.password && (
          ...
          <div className="flex align-middle items-center rounded-lg tips hidden md:flex bg-gradient-to-l from-yellow-300 to-yellow-100 min-h-[32rem] align-middle justify-center">
            <h3 className='prose-xl w-4/5 text-justify'>
              {tip}
            </h3>
          </div>
        </div>
